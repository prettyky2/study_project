...
for q_fac in q_factors:
    ...
    img = cv.imread('/Users/a/Documents/middleExam/kodim21.png',cv.IMREAD_GRAYSCALE)
    ...
    image_width = 768
    # 블록들을 이미지로 재조합하는 함수
    def combine_blocks(blocks, blocks_per_col, blocks_per_row, block_size):
        # 이미지의 높이와 너비
        image_height = blocks_per_col * block_size
        image_width = blocks_per_row * block_size
        # 빈 이미지를 생성합니다.
    ...
    full_image = combine_blocks(shifted_blocks, blocks_per_col=64, blocks_per_row=96, block_size=8)
